use adl::gen::common::db_api::{PageReq, TabularQueryReq};
use adl::gen::common::http::Unit;
use adl::gen::mycscores::apis;
use adl::gen::mycscores::apis::ui::{LoginReq, LoginTokens, RefreshReq, UserWithId};
...
async fn server_user_crud() {
    ...
    {
        let mut req = TabularQueryReq::<UserWithId>::new();
        req.page = PageReq {
            offset: 0,
            limit: 100,
        };
