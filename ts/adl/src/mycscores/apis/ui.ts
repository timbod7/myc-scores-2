...
export type SeasonSorting = 'name';
export const valuesSeasonSorting : SeasonSorting[] = ['name'];

const SeasonSorting_AST : ADL.ScopedDecl =
  {"decl":{"annotations":[],"name":"SeasonSorting","type_":{"kind":"union_","value":{"fields":[{"annotations":[],"default":{"kind":"nothing"},"name":"name","serializedName":"name","typeExpr":{"parameters":[],"typeRef":{"kind":"primitive","value":"Void"}}}],"typeParams":[]}},"version":{"kind":"nothing"}},"moduleName":"mycscores.apis.ui"};

export const snSeasonSorting: ADL.ScopedName = {moduleName:"mycscores.apis.ui", name:"SeasonSorting"};

export function texprSeasonSorting(): ADL.ATypeExpr<SeasonSorting> {
  return {value : {typeRef : {kind: "reference", value : snSeasonSorting}, parameters : []}};
}

export interface SeasonFilter_Name_matches {
  kind: 'name_matches';
  value: string;
}

export type SeasonFilter = SeasonFilter_Name_matches;

export interface SeasonFilterOpts {
  name_matches: string;
}

export function makeSeasonFilter<K extends keyof SeasonFilterOpts>(kind: K, value: SeasonFilterOpts[K]) { return {kind, value}; }

const SeasonFilter_AST : ADL.ScopedDecl =
  {"decl":{"annotations":[],"name":"SeasonFilter","type_":{"kind":"union_","value":{"fields":[{"annotations":[],"default":{"kind":"nothing"},"name":"name_matches","serializedName":"name_matches","typeExpr":{"parameters":[],"typeRef":{"kind":"primitive","value":"String"}}}],"typeParams":[]}},"version":{"kind":"nothing"}},"moduleName":"mycscores.apis.ui"};

export const snSeasonFilter: ADL.ScopedName = {moduleName:"mycscores.apis.ui", name:"SeasonFilter"};

export function texprSeasonFilter(): ADL.ATypeExpr<SeasonFilter> {
