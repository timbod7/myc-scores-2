...
export interface ApiRequests {
   ...
   * Query users
   */
  query_users: common_http.HttpReq<QueryUsersReq, common_db_api.Paginated<UserWithId>>;
}
...
const QueryUsersReq_AST : ADL.ScopedDecl =
  {"decl":{"annotations":[],"name":"QueryUsersReq","type_":{"kind":"struct_","value":{"fields":[{"annotations":[],"default":{"kind":"just","value":{}},"name":"page","serializedName":"page","typeExpr":{"parameters":[],"typeRef":{"kind":"reference","value":{"moduleName":"common.db_api","name":"PageReq"}}}}],"typeParams":[]}},"version":{"kind":"nothing"}},"moduleName":"mycscores.apis.ui"};
